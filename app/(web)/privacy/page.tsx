                ...
                <div className="max-w-md p-4 mx-auto md:max-w-screen-lg md:px-8">
                    <div className="privacy">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ScreenIdle.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to ScreenIdle, accessible from <a href="https://screenidle.app" rel="external nofollow noopener" target="_blank">https://screenidle.app</a></p>
                            </li>
                            <li>
                        ...
                        <p>This site uses Google Analytics to monitor aggregate usage statistics. For more information about Google Analytics, view the <a href="https://policies.google.com/privacy">Google Analytics Privacy Policy</a>.</p>
                        ...
                        <ul>
                            <li>By email: popidle@the-sound.co.uk</li>
                        </ul>
                    </div>
                </div>
            </main>
